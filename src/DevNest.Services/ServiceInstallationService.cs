...
{
    public class ServiceInstallationService : IServiceInstallationService
    {
        private readonly IFileSystemService _fileSystemService;
        private readonly IAppSettingsService _appSettingsService;
        private readonly HttpClient _httpClient;

        public ServiceInstallationService(
        ...
        public async Task<InstallationResult> InstallServiceAsync(ServiceDefinition serviceDefinition, IProgress<string>? progress = null)
        {
            try
            {
                ...
                var servicesDir = Path.Combine(settings.InstallDirectory, "bin", serviceDefinition.ServiceType);
        ...
        public async Task<bool> IsServiceInstalledAsync(string serviceName)
        {
            ...
            {
                var settings = await _appSettingsService.LoadSettingsAsync();
                var serviceDir = Path.Combine(settings.InstallDirectory, "services", serviceName);
        ...
        public async Task<InstallationResult> UninstallServiceAsync(string serviceName, IProgress<string>? progress = null)
        {
            try
            {
