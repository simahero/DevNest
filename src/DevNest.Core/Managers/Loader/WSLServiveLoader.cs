...
{
    public class WSLServiceLoader : IServiceLoader
    {

        private readonly AppState _appState;
        private readonly ICommandManager _commandManager;

        public WSLServiceLoader(AppState appState, WSLCommandManager commandManager)
        {
            _appState = appState;
                    ...
                    if (Enum.TryParse<ServiceType>(categoryName, out var serviceType))
                    {
                        ...
                        foreach (var serviceDir in serviceDirectories)
                        {
                            ...
                            var selectedVersion = service.ServiceType switch
                            {
                                ...
                                ServiceType.PHP => _appState.Settings.PHP.Version,
                                ServiceType.Nginx => _appState.Settings.Nginx.Version,
                                ServiceType.Node => _appState.Settings.Node.Version,
                                ServiceType.Redis => _appState.Settings.Redis.Version,
                                ServiceType.PostgreSQL => _appState.Settings.PostgreSQL.Version,
                                ServiceType.MongoDB => _appState.Settings.MongoDB.Version,
                                _ => string.Empty
                            };
